...
--Audio
	...
	sound:new('bgroov','/Audio/Sound/bgroov.mp3')
	sound:new('waltz','/Audio/Sound/waltz in b.mp3')
	sound:new('motd','/Audio/Sound/march of the drowned.mp3')
	sound:new('in','/Audio/Sound/in.mp3')
	sound:new('bt','/Audio/Sound/bt.mp3')
	sound:new('ub','/Audio/Sound/ub.mp3')
	sound:new('oh','/Audio/Sound/oh.mp3')